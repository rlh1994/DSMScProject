...
\begin{table}[]
	...
	\caption{Structure of the ResNext-50 model. At the end of each block the input is added in (as with the original resnet models) - see example methods in \cref{fig:resnextblocks}.}
